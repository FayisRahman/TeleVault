...
-   **Direct Telegram Link**: High-speed transfers using the MTProto protocol with upto 16 parallel upload workers.
...
-   A Telegram Channel ID where files will be stored.
